...
class User(AbstractUser):
    ...
    position = models.CharField(verbose_name='Должность', max_length=120, blank=True)
...
class Shop(models.Model):
    ...
    state = models.BooleanField(verbose_name='Принимает ли магазин заказы', default=True)
...
class Category(models.Model):
    ...
    shops = models.ManyToManyField(Shop, verbose_name='Магазины данной категории', related_name='categories', blank=True)
...
class ConfirmEmailToken(models.Model):
    ...
    user = models.ForeignKey(
        ...
        on_delete=models.CASCADE,
        verbose_name=_("Пользователь для которого создан токен подтверддения e-mail")
    )
